...
{
    /// <inheritdoc />
    public partial class ReplaceExpensesWithMoneySystem : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Accounts_Couples_CoupleId",
                        column: x => x.CoupleId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Accounts_CoupleId_IsActive",
                table: "Accounts",
                columns: new[] { "CoupleId", "IsActive" });

            migrationBuilder.CreateIndex(
                name: "IX_Accounts_CoupleId_UpdatedAt",
                table: "Accounts",
                columns: new[] { "CoupleId", "UpdatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_Budgets_CoupleId_UpdatedAt",
                table: "Budgets",
                columns: new[] { "CoupleId", "UpdatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_Budgets_CoupleId_Year_Month_Category",
                table: "Budgets",
                columns: new[] { "CoupleId", "Year", "Month", "Category" },
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_CoupleId_TransactionDate",
                table: "Transactions",
                columns: new[] { "CoupleId", "TransactionDate" });

            migrationBuilder.CreateIndex(
                name: "IX_Transactions_CoupleId_Type",
                table: "Transactions",
                columns: new[] { "CoupleId", "Type" });

            migrationBuilder.CreateIndex(
                name: "IX_Transactions_CoupleId_UpdatedAt",
                table: "Transactions",
                columns: new[] { "CoupleId", "UpdatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_Transactions_DestinationAccountId_TransactionDate",
                table: "Transactions",
                columns: new[] { "DestinationAccountId", "TransactionDate" });
        }
